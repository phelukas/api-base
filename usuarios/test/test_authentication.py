from usuarios.test.conftest import (
    comparar_chaves,
...
@pytest.mark.django_db
def test_check_if_patch_returns_status_code_200(api_client, create_usuario):
    caracteres = string.ascii_letters + string.digits
    senha = "".join(random.choice(caracteres) for _ in range(10))
    payload = {
        "usuario": {"id": 1, "email": fake.email(), "password": senha},
...
#     print(".")
#     print("antes")
#     print(api_client.get("/api/usuarios/").json()[0])
#     caracteres = string.ascii_letters + string.digits
#     senha = "".join(random.choice(caracteres) for _ in range(10))
#     payload = {
#         "usuario": {"email": fake.email(), "password": senha},
...
#         print(i)
#         api_client.patch(f"/api/usuarios/{create_usuario.id}", data=i, format="json")
#         payload_get_depois = api_client.get("/api/usuarios/").json()[0]
#         print("payload_get_depois")
#         print(payload_get_depois)
