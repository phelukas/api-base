...
class Pessoa(models.Model):
    ...
    cpf = models.CharField(verbose_name="cpf", max_length=15, unique=True, blank=False, null=False)
...
class Usuario(AbstractUser):
    ...
    pessoa = models.OneToOneField(Pessoa, related_name="usuario_pessoa", on_delete=models.CASCADE, null=False)
